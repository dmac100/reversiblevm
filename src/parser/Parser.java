...
import static instruction.array.GetElementInstruction.GetElementInstruction;
import static instruction.array.NewArrayInstruction.NewArray;
import static instruction.array.PushElementInstruction.PushElement;
...
import static instruction.jump.JumpIfFalseInstruction.JumpIfFalse;
import static instruction.jump.JumpIfTrueInstruction.JumpIfTrue;
import static instruction.jump.JumpInstruction.Jump;
import static instruction.object.GetPropertyInstruction.GetProperty;
import static instruction.object.NewObjectInstruction.NewObject;
import static instruction.object.SetPropertyInstruction.SetProperty;
import static instruction.operator.AddInstruction.Add;
import static instruction.operator.AndInstruction.And;
import static instruction.operator.BitwiseAndInstruction.BitwiseAnd;
import static instruction.operator.BitwiseNotInstruction.BitwiseNot;
import static instruction.operator.BitwiseOrInstruction.BitwiseOr;
import static instruction.operator.BitwiseXorInstruction.BitwiseXor;
import static instruction.operator.DivideInstruction.Divide;
import static instruction.operator.EqualInstruction.Equal;
import static instruction.operator.GreaterThanEqualInstruction.GreaterThanEqual;
import static instruction.operator.GreaterThanInstruction.GreaterThan;
import static instruction.operator.LessThanEqualInstruction.LessThanEqual;
import static instruction.operator.LessThanInstruction.LessThan;
import static instruction.operator.MinusInstruction.Minus;
import static instruction.operator.ModuloInstruction.Modulo;
import static instruction.operator.MultiplyInstruction.Multiply;
import static instruction.operator.NotInstruction.Not;
import static instruction.operator.OrInstruction.Or;
import static instruction.operator.ShiftLeftInstruction.ShiftLeft;
import static instruction.operator.ShiftRightInstruction.ShiftRight;
import static instruction.operator.UnaryMinusInstruction.UnaryMinus;
import static instruction.operator.UnaryPlusInstruction.UnaryPlus;
import static instruction.operator.UnsignedShiftRightInstruction.UnsignedShiftRight;
