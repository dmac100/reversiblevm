...
public class ParserOutputTest {
	...
	public void CallExpression() {
		...
		assertParseOutput("a.b[0]()();", Arrays.asList("PUSH: null", "LOAD: a", "GETPROPERTY: b", "DUP", "PUSH: 0", "GETELEMENT", "PUSH: 1", "SWAP", "CALL", "PUSH: 1", "SWAP", "CALL", "POP"));
		...
		assertParseOutput("f().a[0]();", Arrays.asList("PUSH: null", "LOAD: f", "PUSH: 1", "SWAP", "CALL", "GETPROPERTY: a", "DUP", "PUSH: 0", "GETELEMENT", "PUSH: 1", "SWAP", "CALL", "POP"));
